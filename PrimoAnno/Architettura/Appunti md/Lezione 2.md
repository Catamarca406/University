...
E' un dispositivo di output che permette di trasferire su un supporto (solitamente di carta) i documenti elettronici.

Esistono principalmente tre tipologie di stampa : 

1.  <span style="color:rgb(255, 0, 0)"> Aghi </span> (matrice di punti) : Utilizza una testina contenente degli aghi che scorre orizzontalmente mentre il foglio avanza verticalmente.
	- Caratteristiche: Monocromatiche, lente, rumorose e a bassa qualità grafica.

2.  <span style="color:rgb(255, 0, 0)">Getto d'inchiostro</span> : La testina contiene piccoli ugelli che spruzzano goccioline di inchiostro sul foglio mentre questo scorre. 
	- Caratteristiche: Economiche, silenziose, lente e con costo di manutenzione alto.

3.  <span style="color:rgb(255, 0, 0)">Laser</span> : Utilizza un raggio laser per creare un'immagine elettrostatica su un tamburo fotosensibile. Questo attira il toner --> trasferito sul foglio e fissato con calore e pressione.
	   - Caratteristiche: Molto veloci, silenziose con una qualità alta.



## Apparati per le telecomunicazioni

Sono elementi hardware che permettono la trasmissione, la ricezione e l'instradamento di dati e segnali all'interno di una rete o tra reti diverse.

### Modem 

E' un dispositivo che:

- *Modula* : Converte i segnali digitali (del computer) in segnali analogici.
 
- *Demodula* : Riconverte i segnali analogici entranti in segnali digitali comprensibili dal computer.
 
### DSL 

La *DSL* (Digital Subscriber line) permette la trasmissione di dati digitali ad alta velocità utilizzando i *doppini in rame* della rete telefonica tradizionale.
E' in grado di far utilizzare internet e il telefono allo stesso tempo, dato che i dati viaggiano su frequenze diverse rispetto alla voce.

### ADSL

L' *ADSL* (Asymmetric Digital Subscriber Line) è un tipo di DSL con chiave asimmetrica perché la velocità non è uguale nelle due direzioni: 

- *Download* : La velocità di ricezione dei dati è molto elevata.
- *Upload* : La velocità di invio dei dati è molto più bassa.
...
E' l'insieme di regole che associa un numero binario ad ogni simbolo (lettere,numeri,punteggiatura), permettondo al computer di memorizzare e visualizzare il testo.

### Ascii

E' lo standard più utilizzato

- Ogni carattere viene *codificato* con *7 bit*.
- *Capacità* : Può rappresentare 128 caratteri.
- *Limite* : Include solo l'alfabeto inglese, numeri e simboli base.

### Unicode

E' lo standard universale per superare i limiti di ASCII

- *Obiettivo* : Assegna un codice univoco ad ogni carattere esistente al mondo.
- *Capacità* : Può contenere > 1 milione di simboli
- *Nota* : Unicode è solo un catalogo dei simboli, non definisce come vengono salvati fisicamente.

### UTF-8

E' la codifica più utilizzata sul web oggi.

- *Efficienza* : E' variabile, usa 1 byte per i caratteri ASCII standard (fino a 4 byte per i simboli più complessi).
- *Compatibilità* : E' retrocompatibile con l'ASCII.