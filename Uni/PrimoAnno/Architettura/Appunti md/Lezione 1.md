...
-  Le CPU dovrebbero avere un numero elevato di registri:
	- L'accesso in memoria è lento, devono essere forniti molti registri, così facendo la fetch di una word, può essere tenuta in un registro fino al suo inutilizzo. 
...
- NUMA (Non Uniform Memory Access) -> Il tempo di accesso alla memoria dipende dalla posizione della memoria rispetto al processore
...
- In ogni cella c'è lo stesso quantificativo di informazione binaria
...
![[../../../imm/image-185.png|image-185]]


### Gerarchie di memorie 

![[../../../imm/image-186.png|image-186]]
