...
![363x232](image-147.png)

![296x355](image-148.png)
...
![604x212](image-150.png)

#### Reti delle dipendenze

![298x205](image-151.png)
...
![image-155](image-155.png)

Non ci possono essere archi all'indietro

Un **algoritmo alternativo**

![image-156](image-156.png)


![Screenshot From 2025-12-17 16-43-11](Screenshot%20From%202025-12-17%2016-43-11.gif)
...
![image-160](image-160.png)

Avevamo bisogno di una componente pozzo?

<span style="color:rgb(255, 0, 0)">idea</span>: invertiamo gli archi!

![image-161](image-161.png)


**Pseudocodice:**
![image-162](image-162.png)

**Complessità temporale:** 
Se G è rappresentato con liste di adiacenza -> $\Theta$(n+m)


![Screenshot From 2025-12-18 10-53-57](Screenshot%20From%202025-12-18%2010-53-57.gif)